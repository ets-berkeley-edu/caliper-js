...
const path = config.testFixturesBaseDir.v1p1 + "caliperEventToolLaunchLaunched.json";
...
testUtils.readFile(path, function(err, fixture) {
  ...
  test('toolLaunchEventLaunchedTest', function (t) {
    ...
    const BASE_SECTION_IRI = "https://example.edu/terms/201801/courses/7/sections/1";
