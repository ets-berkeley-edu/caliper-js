...
var path = config.testFixturesBaseDir.v1p1 + "caliperEntityFillinBlankResponse.json";
...
testUtils.readFile(path, function(err, fixture) {
  ...
  test('fillinBlankResponseTest', function (t) {
    ...
    var BASE_ITEM_IRI = "https://example.edu/terms/201601/courses/7/sections/1/assess/1/items/1";
